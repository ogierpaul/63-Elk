...
END
$$ LANGUAGE plpgsql VOLATILE PARALLEL UNSAFE STRICT ;
--
...
SELECT
left(f, 10)
FROM es_search('{"query" : {"bool" : {"should": [{"match": {"surname": {"query": "WALLS", "fuzziness": 1}}}, {"match": {"firstnames": {"query": "Kenneth Charle", "fuzziness": 1}}}, {"match": {"route": {"query": "Squirrel Rise", "fuzziness": 1}}}, {"match": {"locality": {"query": "Marlow", "fuzziness": 1}}}, {"match": {"postalcodelong": {"query": "SL7 3PN", "fuzziness": 0}}}]}}}', 1) as f;

SELECT t.pg_id, left(f, 10)
FROM (SELECT * FROM fdwes.z_text WHERE pg_id>143 LIMIT 5) t
CROSS JOIN LATERAL es_search(t.query, t.pg_id) as f
LIMIT 10;
...
-- FROM
--     fdwes.target_jq b
-- WHERE b."query"='{"query" : {"bool" : {"should": [{"match": {"surname": {"query": "WALLS", "fuzziness": 1}}}, {"match": {"firstnames": {"query": "Kenneth Charle", "fuzziness": 1}}}, {"match": {"route": {"query": "Squirrel Rise", "fuzziness": 1}}}, {"match": {"locality": {"query": "Marlow", "fuzziness": 1}}}, {"match": {"postalcodelong": {"query": "SL7 3PN", "fuzziness": 0}}}]}}}' and b."pg_id" =1;
--
